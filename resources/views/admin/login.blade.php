...
<body class="bg-pattern min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mb-2">BiblioTech Admin</h1>
            <p class="text-blue-200">Connexion à l'interface d'administration</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('home') }}" 
                   class="text-sm text-gray-600 hover:text-blue-600 transition duration-200">
